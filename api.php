        ...
        <div class="inner-form">
          <div class="basic-search">
            <div class="input-field">
              <input id="search" type="text" placeholder="Type Keywords" name="research_name" required>
              <div class="icon-wrap">
          ...
          <div class="advance-search">
            ...
            <div class="row third">
              <div class="input-field">
                ...
                <div class="group-btn">
                  <button class="btn-delete" id="export" onclick="submitForm('excel.php')" name="export">EXPORT</button>
                  <button class="btn-search" name="submit" onclick="submitForm('index.php')" type="submit">SEARCH</button>
                </div>
              </div>
            </div>
          </div>
...
<section class="ftco-section">
	...
	<div class="result-count">
		<span> <?php echo $countResult ?> </span> results</div>
		<span> <?php echo $countInclude ?> </span> includes</div>
		<span> <?php echo $countExclude ?> </span> excludes</div>
	</div>
