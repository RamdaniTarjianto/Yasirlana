...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="images/ss.png">
...
<body>
                ...
                <div class="mx-auto d-flex flex-lg-row flex-column hero">
                    ...
                    <div class="left-column d-flex flex-lg-grow-1 flex-column align-items-lg-start text-lg-start align-items-center text-center">
                        ...
                        <div class="d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
                            ...
                            <button class="btn btn-outline" onclick="window.open('https://drive.google.com/file/d/1DxZpXu13Sf64TNdTX7kfT2fLnrU_pWr-/view?usp=share_link','_blank','resizable=yes,screenX=' + (screen.width/2-250) + ',screenY=' + (screen.height/2-150))">
                    ...
                    <div class="team-active">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team mb-30 text-center">
                                ...
                                <div class="team-info">
                                    <h3><a href="#">Yasin Alfi Yahya</a></h3>
                                    <p>Web Developer</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg- col-md-4 col-sm-6">
                            <div class="single-team mb-30 text-center">
                                ...
                                <div class="team-info text">
                                    <h3><a href="#">Ramdani Tarjianto</a></h3>
                                    <p class="position-subtitle">Machine Learning Engineer</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team mb-30 text-center">
                                ...
                                <div class="team-info">
                                    <h3><a href="#">Aldita Nabila Indria</a></h3>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team mb-30 text-center">
                                ...
                                <div class="team-info">
                                    <h3><a href="#">Yuka Dwi Rahutami</a></h3>
                                    <p>Dentistry Student</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team mb-30 text-center">
                                ...
                                <div class="team-info">
                                    <h3><a href="#">Laode Sunatera Jaya</a></h3>
                                    <p>Dentistry Student</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>Our Partner </h4>
                                <ul>
                                    <li><a href="https://www.yarsi.ac.id/">Universitas YARSI</a></li>
                                    <li><a href="https://www.yarsi.ac.id/akademik/fakultas-teknologi-informasi/teknik-informatika/">FTI Universitas YARSI</a></li>
                                    <li><a href="https://www.yarsi.ac.id/akademik/fakultas-kedokteran-gigi/pendidikan-dokter-gigi/">FKG Universitas YARSI</a></li>
                                    <li><a href="https://rsgmyarsi.com/rsgmyarsi/halaman-utama/?gclid=CjwKCAiAzp6eBhByEiwA_gGq5OrmYqJmSRSCHZ6yoakGbpIu_2V0Z5XwrkgZnn3IG2x_cRTbjQ6ithoCcGgQAvD_BwE">RSGM YARSI</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <i class="icon fas fa-phone-alt"></i> +628123456789
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <!-- <script src="https://kit.fontawesome.com/05d44a7965.js" crossorigin="anonymous"></script> -->
