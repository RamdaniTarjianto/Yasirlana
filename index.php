...
<html lang="en">
    ...
    <body>
        <section class="h-100 w-100 home" style="box-sizing: border-box">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a href="#">
                        <img
                            ...
                            src="assets/img/logo/yasirlana_nav.svg"
                            alt=""/>
                    </a>
                    <button
                    ...
                    <div
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content bg-white border-0">
                                <!-- <div class="modal-header border-0" style="padding: 2rem; padding-bottom:
                                0"> <a class="modal-title" id="targetModalLabel"> <img style="margin-top:
                                0.5rem"
                                src="http://api.elements.buildwithangga.com/storage/files/2/assets/Header/Header2/Header-2-5.png"
                                alt="" /> </a> <button type="button" class="btn-close" data-bs-dismiss="modal"
                                ...
                                <div
                                    ...
                                    <!-- <button class="btn btn-default btn-no-fill">Log In</button> <button
                                    class="btn btn-fill text-white">Try Now</button> -->
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="mx-auto d-flex flex-lg-row flex-column hero">
                        ...
                        <div
                            ...
                            <p>
                                YASIRLANA is an automation system that can be used to assist the process of
                                screening articles or journals in the Systematic Literature Review.</p>
                            ...
                            <div
                                ...
                                <button
                                    ...
                                    onclick="window.open('https://drive.google.com/file/d/1DxZpXu13Sf64TNdTX7kfT2fLnrU_pWr-/view?usp=share_link','_blank','resizable=yes')">
                        ...
                        <!-- Right Column -->
                        <!-- <div class="right-column text-center d-flex justify-content-lg-end
                        justify-content-center pe-0"> <img id="img-fluid" class="h-auto mw-100"
                        src="images/Yasirlana.svg" alt="" /> </div> -->

                        <div
                            class="right-column text-center d-flex justify-content-lg-end justify-content-center position-relative top-10 ml-auto pe-0">
                ...
                <div class="row content">
                    <div class="col-12 px-md-0 my-auto">
                        ...
                        <div class="headline mt-3">
                            ...
                            Fit For Your Literature Review Needs
                        </div>
                        <div class="row benefits text-center px-0">
                            ...
                            <div class="col-md-3 mt-5 mt-md-0">
                                <div class="rectangle mx-auto px-1">
                                    ...
                                    <div class="subheadline-benefit mt-2">
                                        Export your prediction results
                                        <br class="d-none d-md-block">
                                        into excel format
                                    </div>
                                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="cl-xl-8 col-lg-8 col-md-10">
                            ...
                            <div class="section-tittle text-center mb-60">
                                ...
                                <p>This research is a collaboration between the Faculty of Dentistry (FKG) and
                                    the Faculty of Information Technology (FTI) at YARSI University in the leading
                                    research field of health informatics.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="team-active">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="single-team mb-30 text-center">
                                    ...
                                    <div class="team-info">
                                        <h3>
                                            <a href="#">drg. Chaerita Maulani, Sp.Perio</a>
                                        </h3>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="single-team mb-30 text-center">
                                    ...
                                    <div class="team-info">
                                        <h3>
                                            <a href="#">drg. Liana Zulfa, Sp.Perio., MARS.</a>
                                        </h3>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="single-team mb-30 text-center">
                                    ...
                                    <div class="team-info">
                                        <h3>
                                            <a href="#">drg. Dharma Satya Aprianto, Sp.Pros</a>
                                        </h3>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="single-team mb-30 text-center">
                                    ...
                                    <div class="team-info">
                                        <h3>
                                            <a href="#">Chandra Prasetyo Utomo, S.Kom., M.Sc.</a>
                                        </h3>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="single-team mb-30 text-center">
                                    ...
                                    <div class="team-info">
                                        <h3>
                                            <a href="#">Muhammad Fathurachman, S.Kom, M.Kom.</a>
                                        </h3>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="single-team mb-30 text-center">
                                    ...
                                    <div class="team-info">
                                        <h3>
                                            <a href="#">Aldita Nabila Indria</a>
                                        </h3>
                                        <p>Dentistry Student</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-footer-caption mb-50">
                                <div class="single-footer-caption mb-30">
                                    ...
                                    <div class="footer-logo mb-25">
                                        <a href="index-2.html"><img src="assets/img/logo/Yasirlana.png" alt=""></a>
                                    </div>
                                    <div class="footer-tittle">
                                        <div class="footer-pera">
                                            <p>YASIRLANA is an automation system that can be used to assist the process of
                                                screening articles or journals in the Systematic Literature Review.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4">
                            <div class="single-footer-caption mb-50">
                                <div class="footer-tittle">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#">Universitas YARSI</a>
                                        </li>
                                        <li>
                                            <a href="#">FTI Universitas YARSI</a>
                                        </li>
                                        <li>
                                            <a href="#">FKG Universitas YARSI</a>
                                        </li>
                                        <li>
                                            <a href="#">RSGM YARSI</a>
                                        </li>
                                ...
                                <div class="footer-tittle">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Jl. Letjen Suprapto, Cemp. Putih, Kota Jakarta Pusat
                                        </li>
        ...
        <!-- <script src="https://kit.fontawesome.com/05d44a7965.js"
        crossorigin="anonymous"></script> -->
