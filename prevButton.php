...
<button class="btn btn-default" type=""><a class="" href="javascript:history.go(-1)">Prev</a></button>
<!-- <li class="page-item"><a class="page-link" href="javascript:history.go(-1)">Previous</a></li> -->
</div>
    <div class="input-group-btn">
        <form name="form2" id="form2">
        <input class="form-control page-item" name="halaman" id="halaman" style="width: 50px;" value="<?= $_GET['page'] ?>" />
...
<div class="input-group-btn">
    ...
    formEl.addEventListener('submit' , (e) => {
        ...
        window.location.replace(`${currUrl}?${objUrl.toString()}`)
    })
