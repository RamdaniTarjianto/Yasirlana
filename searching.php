                        ...
                        <div class="row mt-4 g-1 px-4 mb-5">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="databases[]" data-placeholder="Choose Database" id="databaseform">
                                        <option selected="selected" disabled="disabled" value="" title="Pilih sumber database yang kamu inginkan"></option>
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <div class="input-group input-daterange">
                                    <input type="text" class="form-control" value="" name="startDate" id="startDate" required="required" placeholder="Start">
                                    <div class="input-group-addon d-flex align-items-center ml-2 mr-2">to</div>
                                    <input type="text" class="form-control" value="" name="finishDate" id="finishDate" required="required" placeholder="End">
                                    <input type="submit" class="btn btn-success ml-4 searchButton" name="submit" id="btnCari" value="Search">
                                </div>
            ...
            <div class="mb-3">
                ...
                <div class="row d-flex justify-content-end mx-auto">
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="excelPage.php?<?php echo http_build_query($_GET); ?>" onclick="return confirm('Apakah Anda yakin ingin mengekspor halaman ini?')">Export This Page (.xls)</a>
                        <a class="dropdown-item" href="excel.php?<?php echo http_build_query($_GET); ?>" title="<?php echo $notif; ?>" onclick="return confirm('<?php echo $notif; ?> Ingin melanjutkan export?')">Export All Pages (.xls)
